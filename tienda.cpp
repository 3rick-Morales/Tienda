...
{
    ui->setupUi(this);
    connect(ui->mnuAgregar, SIGNAL(triggered()),
            this, SLOT(on_cmdAgregar_clicked()));
    connect(ui->mnuFinalizar, SIGNAL(triggered()),
            this, SLOT(on_cmdFinalizar_clicked()));
...
void Tienda::acercade()
{
    Acercade *ventana1 = new Acercade(this);
